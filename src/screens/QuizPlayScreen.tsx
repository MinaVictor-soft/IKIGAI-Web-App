...
export default function QuizPlayScreen() {
  ...
  if (previousResult && !result) {
    ...
    return (
      <View style={styles.container}>
        ...
        {/* Answers Review */}
        <ScrollView style={styles.reviewContainer} contentContainerStyle={styles.reviewContent} scrollEnabled={true} showsVerticalScrollIndicator={false}>
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Question */}
      <ScrollView style={styles.questionContainer} contentContainerStyle={styles.questionContent} scrollEnabled={true} showsVerticalScrollIndicator={false}>
